...
{ 
  ...
  if (browserVersion > 0) 
    auxEv = "<a href='javascript: voidfunc()' onclick='clickOnNode(\""+this.getID()+"\"); return false;'>" 
  else 
    auxEv = "<a>" 
...
function highlightObjLink(nodeObj) {
  ...
  lastClicked = nodeObj;
  if (PRESERVESTATE)  SetCookie('highlightedTreeviewLink', nodeObj.getID());
}
